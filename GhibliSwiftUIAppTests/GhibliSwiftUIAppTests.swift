...
//    
//    actor MockGhibliService: GhibliAPIService { //could be a struct but we have mutating vars
//        
//        let mockFilms: [Film]
...
//        } // creating a task
//        
//        try? await Task.sleep(for: .milliseconds(550)) //  waiting - in order to not directly cancelling
//        task.cancel() // cancelling before we finished waiting it
//        
//        await task.value
//        
//        await task.value
...
//        #expect(service.lastSearchQuery == "tot")
